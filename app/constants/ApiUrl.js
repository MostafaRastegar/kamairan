...
export const API_SHOWTIMES_CINEMA_MOVIE = (cinemaId, movieId) =>
  `${API_ROOT_URL}showtime/${cinemaId}/${movieId}`;
export const API_MOVIE_DETAIL = movieId => `${API_ROOT_URL}movie/${movieId}`;
export const API_ALL_CINEMA_SHOW_A_MOVIE = movieId =>
  `${API_ROOT_URL}movie/cinema/${movieId}`;
export const API_ALL_SANSE_OF_A_MOVIE_IN_A_CINEMA = (cinemaId, movieId) =>
  `${API_ROOT_URL}showtime/${cinemaId}/${movieId}`;
